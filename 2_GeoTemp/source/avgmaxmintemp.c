...
|	Celsius o Fahrenheit, en format Q14 (coma fixa 1:17:14).
| ----------------------------------------------------------------
...
|	Resultat:	temperatura mitjana, expressada en graus Celsius, en format Q14.
*/		
Q14 avgmaxmin_city(Q14 ttemp[][12], unsigned short nrows, unsigned short id_city, t_maxmin *mmres)
{
	...
	unsigned short i;
	Q14 tvar;						// variable temporal de temperatura
